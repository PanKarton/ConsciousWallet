...
Originally I wanted to build an application that allowed users to add their expenses with categories and display it with charts, day list with calendar and stuff. I started this process by using the `create-react-app` boilerplate, then adding `react-router-6.0` and `redux toolkit`.  
